...
| `VITE_API_TIMEOUT_MS` | Axios request timeout in milliseconds. Timed-out requests are retried once after a short delay so cold-started backends can continue showing the current loading indicator before an error is displayed. | `10000` |
