...
### Fixed
- **Directional-scan turnaround eligibility**: Filtered DIRECTIONAL_SCAN turnaround-floor selection by hall-call direction so opposite-direction hall calls ahead are not selected as unreachable turnaround targets that cause overshoot before reversal. Updated README and package metadata for the 0.52.18 patch release.
