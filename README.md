...
java -jar target/lift-simulator-0.35.1.jar
```
...
```bash
java -jar target/lift-simulator-0.35.1.jar --spring.jpa.verify=true
```
...
The current version (v0.35.1) includes comprehensive lift simulation and configuration management capabilities:
...
The packaged JAR will be in `target/lift-simulator-0.35.1.jar`.
...
```bash
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.Main
```
...
```bash
# Show help
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.Main --help

# Run with the default demo configuration (nearest-request routing)
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.Main

# Run with directional scan controller
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.Main --strategy=directional-scan

# Run with nearest-request routing controller (explicit)
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.Main --strategy=nearest-request
```
...
```bash
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.runtime.LocalSimulationMain --config=path/to/config.json
```
...
```bash
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.scenario.ScenarioRunnerMain path/to/scenario.scenario
```
...
```bash
# Show help
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.scenario.ScenarioRunnerMain --help

# Run with default demo scenario
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.scenario.ScenarioRunnerMain

# Run a custom scenario
java -cp target/lift-simulator-0.35.1.jar com.liftsimulator.scenario.ScenarioRunnerMain custom.scenario
```
